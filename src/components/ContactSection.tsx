...
const contactInfo = [
  { icon: MapPin, label: "Location", value: "Coimbatore, India" },
  {
    icon: Mail,
    label: "Email",
    value: "kaviyasanthosh0029@gmail.com",
    href: "mailto:kaviyasanthosh0029@gmail.com",
  },
  {
    icon: Phone,
    label: "Phone",
    value: "+91 8870180847",
    href: "tel:+918870180847",
  },
  {
    icon: Linkedin,
    label: "LinkedIn",
    value: "Kaviya Santhosh",
    href: "https://www.linkedin.com/in/kaviya-santhosh-8576a8243",
  },
];
